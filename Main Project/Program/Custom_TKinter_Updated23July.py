...
# window.state("zoomed")
appicon = tkinter.PhotoImage(file="Icons/App_Icon.png")
...
frameOne = tkinter.Frame(window , bg="#D6F5EF" , width=1280,height=160)
frameOne.grid(row=0 , column=0 , sticky=tk.NW)
# frameOne.pack(expands = True , fill = "both")

# Parent Paint Frame Which Contain Only The Canvas Frame
frameTwo = tkinter.Frame(window , bg="yellow" , width=1280,height=800)
frameTwo.grid(row=1 , column=0)

frameFoot = tkinter.Frame(window , bg="yellow" , width=1280,height = 35)
...
iconOfPencil = tkinter.PhotoImage(file="Icons/Small_Pencil.png")
iconOfEraser = tkinter.PhotoImage(file="Icons/Small_Eraser.png")
iconOfFont = tkinter.PhotoImage(file="Icons/Small_Font.png")
iconOfGlass = tkinter.PhotoImage(file="Icons/Small_Glass.png")
iconOfFill = tkinter.PhotoImage(file="Icons/Small_Fill.png")
iconOfSave = tkinter.PhotoImage(file="Icons/Small_Save.png")
iconOfClear = tkinter.PhotoImage(file="Icons/Small_Clear.png")
iconOfSelectColor = tkinter.PhotoImage(file="Icons/Small_MoreColorsWithPlus.png")

iconOfZoomIn = tkinter.PhotoImage(file="Icons/Small_Zoom_In.png")
iconOfZoomOut = tkinter.PhotoImage(file="Icons/Small_Zoom_Out.png")
...
colorFrame=tkinter.Frame(frameOne , height=170, width=230 , borderwidth=0 ,relief="sunken" ,bg="#D6F5EF")
...
coloursLabel = tkinter.Label(frameOne , text="Colours" , width=20 ,bg="#D6F5EF"  )
...
menuFrame = tkinter.Frame(frameOne , height=30 , width=1280 , bg="#FF9578")
...
HelpSettingFrame=tkinter.Frame(frameOne , height=30, width=240 , borderwidth=0 ,relief="sunken",bg="white")
...
zoomFrame = tkinter.Frame(frameFoot, width=300,height = 35 )
...
zoom_scrollbar = tkinter.Scale(zoomFrame, from_=10, to=200, orient="horizontal",width = 7 ,length = 200, variable=value)
...
zoom_Out_Label = tkinter.Button(zoomFrame ,  image= iconOfZoomOut , width=20 , height=20,command=decrement_zoom_scale)
zoom_Out_Label.place(x = 10 , y = 10)

zoom_In_Label = tkinter.Button(zoomFrame , image= iconOfZoomIn , width=20 , height=20 ,command=increment_zoom_scale)
zoom_In_Label.place(x = 270 , y = 10)

showCordinates = tkinter.Frame(frameFoot , width=200 , height=35)
...
toolFrame = tkinter.Frame(frameOne , height=120 , width=120 , bg="#D6F5EF", highlightthickness=0 , relief="flat" )
toolFrame.place(x = 20  , y = 50 )

#Pencil Button/Icon -> Onclicking The Button The User Can Use The Pencil
pencilIcon = tkinter.Button(toolFrame ,  width=25 , height=25 , image= iconOfPencil , command=usePencil, highlightthickness=0 , relief="flat" )
pencilIcon.place(x = 5 , y = 5 )

# Rubber Button/Icon
eraserIcon = tkinter.Button(toolFrame , width=25, height=25 , image=iconOfEraser , command= useEraser, highlightthickness=0 , relief="flat")
eraserIcon.place(x = 5 , y = 40)

# Font Icon
fontIcon = tkinter.Button(toolFrame , width=25, height=25 , image=iconOfFont, highlightthickness=0,command= addText , relief="flat")
fontIcon.place(x = 40 , y = 5)

# Glass Icon
glassIcon = tkinter.Button(toolFrame , width=25, height=25, image=iconOfGlass, highlightthickness=0 , relief="flat")
glassIcon.place(x = 40 , y = 40)

# Fill Icon
fillIcon = tkinter.Button(toolFrame , width=25, height=25, image=iconOfFill, highlightthickness=0 , relief="flat")
fillIcon.place(x=80, y = 5)

# One More Icon keep x = 80 and y = 40

# ToolLabel
toolLabel = tkinter.Label(toolFrame , text="Tool Bar" , width=25 , bg="#D6F5EF")
toolLabel.place(x=-30 , y= 80)

# ----------------------------------------------------------------------------------------------------
# Adding Borders Along The Different Tools
border_frame_one = tkinter.Frame(frameOne , width=2 , height= 100 , bg="black")
border_frame_one.place(x = 160 , y = 50)

border_frame_two = tkinter.Frame(frameOne , width=2 , height= 100 , bg="black")
border_frame_two.place(x = 400 , y = 50)

border_frame_three = tkinter.Frame(frameOne , width=2 , height= 100 , bg="black")
...
scale = tkinter.Scale(frameOne , from_=1, to=50 , orient="horizontal" , length=200 , bg="#D6F5EF" , background="#D6F5EF" ,troughcolor="#706D68",variable=stroke_size , highlightthickness=0)
scale.place(x = 180 ,y = 50)

scale_label = tkinter.Label(frameOne , text="Pencil & Eraser Size", bg="#D6F5EF")
...
canvas = tkinter.Canvas(frameTwo , width=1280 , height=800 , bg="white")
...
window.bind_all("<Control-a>" , lambda event : ClearAllEvent(event))
